...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 1565489432f6498fgrff</DialogTitle>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell className="text-right">R$ 65,40</TableCell>
              <TableCell className="text-right">R$ 130,80</TableCell>
            </TableRow>

            <TableRow>
              <TableCell>Pizza Frango Cream Cheese</TableCell>
              <TableCell className="text-right">2</TableCell>
